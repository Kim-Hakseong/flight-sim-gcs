# CLAUDE.md — flight-sim-gcs Operating Manual

> Read first, every session. **PRD.md wins on any conflict.**
> Lineage: forked from flight-sim2 (which drifted toward a game). This project is
> **GCS-first** — the Ground Control Station / MAVLink loop is the point.
